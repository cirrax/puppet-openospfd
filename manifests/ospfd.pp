# @summary main class to configure ospfd
#
...
#     negativ: true
#
class openospfd::ospfd (
  String           $config_file    = '/etc/ospfd.conf',
  String           $service_name   = 'ospfd',
  String           $service_ensure = 'running',
  String           $service_enable = 'true',
  String           $validate_cmd   = '/usr/sbin/ospfd -nf %',
